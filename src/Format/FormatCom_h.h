...
EXTERN_C const IID IID_ITrueCryptFormatCom;
    ...
    MIDL_INTERFACE("7AB357D9-A17F-466e-BCD6-F49E97C218D8")
    ...
    public:
        ...
        virtual BOOL STDMETHODCALLTYPE FormatFs( 
            int driveNo,
            int clusterSize,
            int fsType) = 0;
    ...
    typedef struct ITrueCryptFormatComVtbl
    {
        ...
        BOOL ( STDMETHODCALLTYPE *FormatFs )( 
            ITrueCryptFormatCom * This,
            int driveNo,
            int clusterSize,
            int fsType);
...
#define ITrueCryptFormatCom_FormatFs(This,driveNo,clusterSize,fsType)	\
    ( (This)->lpVtbl -> FormatFs(This,driveNo,clusterSize,fsType) ) 

#define ITrueCryptFormatCom_GetFileSize(This,filePath,pSize)	\
    ( (This)->lpVtbl -> GetFileSize(This,filePath,pSize) ) 

#define ITrueCryptFormatCom_DeviceIoControl(This,readOnly,device,filePath,dwIoControlCode,input,output)	\
    ( (This)->lpVtbl -> DeviceIoControl(This,readOnly,device,filePath,dwIoControlCode,input,output) ) 

#define ITrueCryptFormatCom_InstallEfiBootLoader(This,preserveUserConfig,hiddenOSCreation,pim,hashAlg)	\
    ( (This)->lpVtbl -> InstallEfiBootLoader(This,preserveUserConfig,hiddenOSCreation,pim,hashAlg) ) 

#define ITrueCryptFormatCom_BackupEfiSystemLoader(This)	\
    ( (This)->lpVtbl -> BackupEfiSystemLoader(This) ) 

#define ITrueCryptFormatCom_RestoreEfiSystemLoader(This)	\
    ( (This)->lpVtbl -> RestoreEfiSystemLoader(This) ) 

#define ITrueCryptFormatCom_GetEfiBootDeviceNumber(This,pSdn)	\
    ( (This)->lpVtbl -> GetEfiBootDeviceNumber(This,pSdn) ) 

#define ITrueCryptFormatCom_WriteEfiBootSectorUserConfig(This,userConfig,customUserMessage,pim,hashAlg)	\
    ( (This)->lpVtbl -> WriteEfiBootSectorUserConfig(This,userConfig,customUserMessage,pim,hashAlg) ) 

#define ITrueCryptFormatCom_UpdateSetupConfigFile(This,bForInstall)	\
    ( (This)->lpVtbl -> UpdateSetupConfigFile(This,bForInstall) ) 

#define ITrueCryptFormatCom_GetSecureBootConfig(This,pSecureBootEnabled,pVeraCryptKeysLoaded)	\
...
class DECLSPEC_UUID("A96D3797-9F31-49f4-A0CE-9657392CF789")
TrueCryptFormatCom;
#endif
